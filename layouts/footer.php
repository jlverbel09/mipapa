     ...
     <div class="container">
         <div class="row">
             ...
             <div class="col-md-4 pt-5">
                 ...
                 <ul class="list-unstyled text-light footer-link-list">
                     ...
                     <li>
                         ...
                         <a class="text-decoration-none" href="tel:3222934109">+57 322 293 41 09</a>
                     </li>
                     <li>
             ...
             <div class="col-md-4 pt-5">
                 ...
                 <ul class="list-unstyled text-light footer-link-list">
                     <li><a class="text-decoration-none" href="#">Sandalias y Abiertos</a></li>
                     <li><a class="text-decoration-none" href="#">Calzado Cerrado</a></li>
                     <li><a class="text-decoration-none" href="#">Tacon</a></li>
                     <li><a class="text-decoration-none" href="#">Plataforma</a></li>
                 </ul>
             </div>
         ...
         <div class="row text-light mb-4">
             ...
             <div class="col-auto">
                 ...
                 <div class="input-group mb-2">
                     ...
                     <div class="input-group-text btn-success text-light">Subscribirme</div>
                 </div>
             </div>
         </div>
     </div>
             ...
             <div class="row pt-2">
                 <div class="col-12">
                     <p class="text-left text-light">
                         Copyright &copy; 2025 <a rel="sponsored" href="https://georkingweb.com" target="_blank"> @georkingBusiness</a>
                     </p>
                 </div>
             </div>
         </div>
